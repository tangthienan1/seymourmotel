    ...
    <section>
        ...
        <div class="location__map-wrapper px-6">
            ...
            <div class="location__map-popup location__map-car">
                <div class="d-flex" style="padding-bottom: 64px">
                    <div class="pt-1">
                    ...
                    <div class="ml-3" style="flex: 1">
                        ...
                        <div class="d-flex">
                            <svg width="17" height="22" viewBox="0 0 17 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.12788 0C3.64661 0 0.000976562 3.64563 0.000976562 8.1269C0.000976562 9.60217 0.662602 11.1888 0.690329 11.2558C0.904019 11.763 1.32566 12.5508 1.6297 13.0126L7.20189 21.4555C7.42992 21.8016 7.76743 22 8.12788 22C8.48833 22 8.82584 21.8016 9.05387 21.456L14.6265 13.0126C14.9311 12.5508 15.3522 11.763 15.5659 11.2558C15.5936 11.1893 16.2548 9.60265 16.2548 8.1269C16.2548 3.64563 12.6091 0 8.12788 0ZM14.6844 10.8848C14.4936 11.3394 14.1011 12.0723 13.8282 12.4863L8.25552 20.9296C8.14557 21.0965 8.11067 21.0965 8.00072 20.9296L2.42805 12.4863C2.15508 12.0723 1.7626 11.3389 1.57186 10.8843C1.56373 10.8647 0.957083 9.40426 0.957083 8.1269C0.957083 4.17292 4.1739 0.956106 8.12788 0.956106C12.0819 0.956106 15.2987 4.17292 15.2987 8.1269C15.2987 9.40617 14.6906 10.8704 14.6844 10.8848Z" fill="black" />
                                <path d="M8.12767 3.82471C5.75509 3.82471 3.8252 5.75509 3.8252 8.12719C3.8252 10.4993 5.75509 12.4297 8.12767 12.4297C10.5002 12.4297 12.4301 10.4993 12.4301 8.12719C12.4301 5.75509 10.5002 3.82471 8.12767 3.82471ZM8.12767 11.4736C6.28286 11.4736 4.7813 9.97248 4.7813 8.12719C4.7813 6.2819 6.28286 4.78081 8.12767 4.78081C9.97247 4.78081 11.474 6.2819 11.474 8.12719C11.474 9.97248 9.97247 11.4736 8.12767 11.4736Z" fill="black" />
                            </svg>
                            <p class="ml-2">
                                144 Goulburn Valley Hwy, Seymour,<br />VIC 3660
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex">
                    <div class="pt-1">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 0.5C7 0.5 0.5 7 0.5 15C0.5 23 7 29.5 15 29.5C23 29.5 29.5 23 29.5 15C29.5 7 23 0.5 15 0.5ZM15 28C7.825 28 2 22.175 2 15C2 7.825 7.825 2 15 2C22.175 2 28 7.825 28 15C28 22.175 22.175 28 15 28Z" fill="#222222" />
                            <path d="M15.5 9.25H12.5C12.075 9.25 11.75 9.575 11.75 10V21.25C11.75 21.675 12.075 22 12.5 22C12.925 22 13.25 21.675 13.25 21.25V17.75H15.5C17.85 17.75 19.75 15.85 19.75 13.5C19.75 11.15 17.85 9.25 15.5 9.25ZM15.5 16.25H13.25V10.75H15.5C17.025 10.75 18.25 11.975 18.25 13.5C18.25 15.025 17.025 16.25 15.5 16.25Z" fill="#222222" />
                        </svg>
                    </div>
                    <div class="ml-3" style="flex: 1">
                        <h3 class="pb-3">Parking Information</h3>
                        <p class="mb-3">
                        ...
                        <div class="d-flex">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.001 22.9443C21.091 22.9443 22.501 21.4743 22.916 18.9043C22.9632 18.5727 22.9433 18.2349 22.8574 17.9111C22.7715 17.5873 22.6214 17.284 22.416 17.0193L22.336 16.9443L19.301 14.5443C18.8424 14.201 18.2797 14.0255 17.7072 14.0473C17.1347 14.0692 16.5871 14.287 16.156 14.6643L14.846 15.9043C12.116 15.2843 8.19598 11.7443 8.00098 9.13435L9.29598 7.76935C9.66716 7.33607 9.87897 6.78887 9.89625 6.2186C9.91353 5.64833 9.73524 5.08931 9.39098 4.63435L7.00098 1.60935C6.97604 1.5761 6.9456 1.54735 6.91098 1.52435C6.64693 1.3196 6.34451 1.16987 6.02161 1.08399C5.6987 0.998107 5.36185 0.977829 5.03098 1.02435C2.47098 1.44435 1.00098 2.85435 1.00098 4.94435C1.00098 9.71825 2.8974 14.2966 6.27305 17.6723C9.64871 21.0479 14.2271 22.9443 19.001 22.9443ZM5.19098 2.01935C5.26256 2.01439 5.3344 2.01439 5.40598 2.01935C5.71408 2.02052 6.01436 2.11653 6.26598 2.29435L8.60098 5.24435C8.80391 5.5142 8.90986 5.84463 8.90169 6.18217C8.89353 6.51971 8.77172 6.84463 8.55598 7.10435L7.13598 8.60435C7.04964 8.69656 7.00141 8.81803 7.00098 8.94435C7.00098 12.1643 11.646 16.3943 14.921 16.9443C14.997 16.9569 15.075 16.9517 15.1487 16.9292C15.2224 16.9066 15.29 16.8673 15.346 16.8143L16.846 15.4093C17.1038 15.1894 17.4285 15.0633 17.7671 15.0515C18.1058 15.0397 18.4385 15.1429 18.711 15.3443L21.686 17.6843C21.9103 17.9947 22.0036 18.3808 21.946 18.7593C21.701 20.2093 21.001 21.9443 19.001 21.9443C14.4923 21.9443 10.1683 20.1533 6.98016 16.9652C3.79204 13.777 2.00098 9.45303 2.00098 4.94435C2.00098 2.94435 3.73598 2.24435 5.19098 2.01935Z" fill="black" />
                            </svg>

                            <p class="ml-2">+61 3 5792 1500</p>
                        </div>
                    </div>
                </div>
            </div>
