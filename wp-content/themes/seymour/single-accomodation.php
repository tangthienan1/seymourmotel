			...
			<div class="accomodations accomodations-detail">
						...
						<div class="col-md-8">
							...
							<div id="carousel-gallery" class="carousel slide" data-ride="carousel">
								...
								<ol class="carousel-indicators">
									<?php  $j=0; while (have_rows('gallery')) : the_row(); $active=($j==0)? "active":"";?>
				...
				<div class="col-md-4">
					<div class="accd-right theme-blue-bg">
						<span class="pt"><?php echo _e('Price:','Seymour');?></span>
						<span class="pv"><?php echo "$".get_field('price');?> / night for prices</span>
						<div class="check-and-book price-book">
                            <form class="form-horizontal" action="<?php echo home_url('/book-now');?>" method="post">
					...
					<?php $args = array( 'orderby'=>'menu_order','order'=>'ASC' ,'post_status' => 'publish', 'post_type' => 'accomodation','exclude'=>get_the_ID()); $rooms=get_posts($args);?>
					<?php 
					if($rooms):?>
